...
using Microsoft.AspNetCore.Mvc.Rendering; // Necessário para usar SelectListItem
...
namespace AmsT4_BLOG_2.Controllers
{
    public class NewsController : Controller
    {
        ...
        public IActionResult CreateNews()
        {
            ...
            {
                new SelectListItem { Value = "Esportes", Text = "Esportes" },
                new SelectListItem { Value = "Política", Text = "Política" },
                new SelectListItem { Value = "Entretenimento", Text = "Entretenimento" },
                new SelectListItem { Value = "Tecnologia", Text = "Tecnologia" },
                new SelectListItem { Value = "Educação", Text = "Educação" }
            };
        ...
        public async Task<IActionResult> EditNews(int? id)
        {
            ...
            // Carregar as categorias para o Edit
            ViewBag.Categories = new List<SelectListItem>
            {
                new SelectListItem { Value = "Esportes", Text = "Esportes" },
                new SelectListItem { Value = "Política", Text = "Política" },
